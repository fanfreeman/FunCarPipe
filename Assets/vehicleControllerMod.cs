...
public class vehicleControllerMod : MonoBehaviour {
    ...
    public GameObject colSuspension;

    public GameObject colLB;
    public GameObject colLF;
    public GameObject colRB;
    public GameObject colRF;

    public GameObject turnLF;
    public GameObject turnRF;
...
//        wheels.transform.rotation = physicsBody.transform.rotation;
        ...
        //create rigidbody//
        rbody = physicsBody.GetComponent<Rigidbody>();
...
//        SphereCollider col = colLB.GetComponent<SphereCollider>();
...
//        col = colLF.GetComponent<SphereCollider>();
...
//        wheelScript = colLF.GetComponent<wheel>();
//        wheelScript.vehicleObj = gameObject;
...
//        jbody = suspensionBody.GetComponent<Rigidbody>();

...
public class camMod : MonoBehaviour
{
    ...
    [Tooltip("Drag your vehicle here. This is the GameObject with the vehicleControllerMod script attached")]
    ...
    private void resetLookAtOffset()
{
    ...
    void Start()
    {
        ...
        physicsBody = carObj.GetComponent<vehicleControllerMod>().physicsBody;
    ...
    void Update()
    {
        ...
        float fov = initFOV + (carObj.GetComponent<vehicleControllerMod>().zVel * FieldOfViewEffect);
        if (fov < initFOV)
        {
            fov = initFOV;
        }
